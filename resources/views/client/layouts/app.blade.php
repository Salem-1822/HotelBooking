            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <div class="d-flex gap-3 mt-3 mt-lg-0">
                    @auth('web')
                        <div class="dropdown">
                            <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle text-white"
                                ...
                                <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::guard('web')->user()->name) }}&background=D4AF37&color=fff"
                                    class="rounded-circle" width="38" height="38" alt="">
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end shadow-sm"
                                style="border-radius: 0.875rem; border: 1px solid var(--border-color);">
                                <li><a class="dropdown-item py-2" href="{{ route('client.dashboard') }}"><i
                                            class="bi bi-grid-fill me-2 text-muted"></i> Dashboard</a></li>
                                <li><a class="dropdown-item py-2" href="{{ route('client.reservations.index') }}"><i
                                            class="bi bi-calendar-check-fill me-2 text-muted"></i> My Reservations</a></li>
                                <li><a class="dropdown-item py-2" href="{{ route('client.profile.edit') }}"><i
                                            class="bi bi-person-fill me-2 text-muted"></i> My Profile</a></li>
                                <li>
                    ...
                    @else
                        ...
                        <a href="{{ route('client.register') }}" class="btn btn-accent">Register</a>
                    @endauth
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p style="color: rgba(255,255,255,0.6); font-size: 0.95rem;">Experience luxury and comfort at our
                        carefully curated selection of hotels worldwide. Your perfect stay is just a click away.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p style="color: rgba(255,255,255,0.6); font-size: 0.95rem;">Subscribe to get special offers and
                        updates.</p>
                    <div class="input-group mt-3">
                        <input type="email" class="form-control bg-transparent text-white" placeholder="Email address"
            ...
            <div class="border-top mt-5 pt-4 text-center" style="border-color: rgba(255,255,255,0.1) !important;">
                <p class="mb-0" style="color: rgba(255,255,255,0.5); font-size: 0.85rem;">&copy; {{ date('Y') }}
                    HotelBooking. All rights reserved.</p>
            </div>
        </div>
    </footer>
